...
//import static week4.day3.PostItNotes.postItNotes;

/**
 * Created by perrythomson on 8/3/16.
 */
public class PostItNoteContent {



    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        PostItNoteContent pinc = new PostItNoteContent();
...
//            Statement stmt = conn.createStatement();
//
//            stmt.executeUpdate("SELECT postIt_details.refFD, postIt_format.postItDesc FROM postIt_details JOIN postIt_format ON postIt_details.refFD = postIt_format.DESC )");
//
//            stmt.close();
//            conn.close();
//        } catch(Exception e) {
